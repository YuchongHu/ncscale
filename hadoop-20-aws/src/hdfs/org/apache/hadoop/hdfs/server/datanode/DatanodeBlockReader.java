...
//        DataNode.LOG.info("DatanodeBlockReader.getBlockReader inline"); 
        ...
        DataNode.LOG.info("DatanodeBlockReader.getBlockReader checksumfirst");
  ...
  /**
   *xiaolu start Feb 25 2016
   *get the ProfilingData
   */
  public FSDataNodeReadProfilingData getProfilingData() {
    return dnData;
  }
}
