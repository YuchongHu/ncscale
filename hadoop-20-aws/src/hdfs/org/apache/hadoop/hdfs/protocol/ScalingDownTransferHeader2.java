...
public class ScalingDownTransferHeader2 extends DataTransferHeader implements Writable {
  ...
  public ScalingDownTransferHeader2(final VersionAndOpcode versionAndOp, Configuration conf) {
    super(versionAndOp);
    this.conf = conf;
  }

  public ScalingDownTransferHeader2(int dataTransferVersion, final int namespaceId, int transferID,
    ...
    super(dataTransferVersion, DataTransferProtocol.OP_SCALING_DOWN_2_TRANSFER);
