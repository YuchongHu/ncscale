...
/**
 * ia code
 * N. B. Shah, K. V. Rashmi, P. V. Kumar, and K. Ramchandran. Interference Alignment in Regenerating Codes for
 * Distributed Storage: Necessity and Code Constructions. IEEE Trans. on Info. Theory, 58(4):2134--2158, Sept. 2012.
 * support all parameters satisfy the constaints theoretically
 */
